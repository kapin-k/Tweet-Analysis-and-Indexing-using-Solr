...
def preprocessData(json_file_name):
    ...
    try:
        if lang in ['en','hi','pt'] :
            ...
            if 'tweet_xx' in j:
                del j['tweet_xx']
            if j['poi_name'] in ['HillaryClinton','KamalaHarris','SenWarren','JoeBiden','mike_pence']:
            ...
            elif j['poi_name'] in ['myogiadityanath','AmitShah','rajnathsingh','JM_Scindia','narendramodi']:
...
def start():
    ...
    for x in india_politicians :
        listOfFiles = getListOfFiles('C:/Users/Kapindran/Project1/India/'+x)
